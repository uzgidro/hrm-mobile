...
export default {
  ...
  fieldAuthor: 'Муаллиф',
  detailLeadership: 'Раҳбарият',
  fieldAddressee: 'Адресат',
  fieldActualReturn: 'Келган сана (КАДР)',
  fieldBasisDecree: 'Асос буйруқ (КАДР)',
  basisDecreeSet: 'Киритиш',
  basisDecreeNumber: 'Буйруқ рақами',
  basisDecreeNumberPlaceholder: 'Масалан: 145',
  basisDecreeDate: 'Буйруқ санаси',
  fieldGuvohnomaNumber: 'Гувоҳнома рақами',
  fieldRegistry: 'Девонхона рўйхати',
  registryNotRegistered: 'Рўйхатдан ўтмаган',
  sectionWorkPlan: 'Режа / мақсад',
  extensionPending: 'Сафарни {{date}} гача узайтириш сўралган — раҳбарият тасдиғи кутилмоқда.',
  extendTripAction: 'Сафарни узайтириш',
  extensionApprove: 'Узайтиришни тасдиқлаш',
  extensionReject: 'Рад этиш',
  extensionDecideConfirm: 'Сафар муддатини узайтириш сўрови бўйича қарор қабул қилинади.',
  fieldDate: 'Сана',
  ...
  cancelTripAction: 'Сафарни бекор қилиш',
  deleteAction: 'Ўчириш',
  ...
  fieldCreator: 'Ҳужжат яратувчиси',
  creatorSelf: 'Ўзим (жорий фойдаланувчи)',
  pickerCreator: 'Ҳужжат яратувчиси',
  ...
  regionRequired: 'Камида битта вилоят танланиши шарт',
