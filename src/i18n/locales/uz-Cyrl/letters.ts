...
export default {
  ...
  sectionAgreement: 'Келишув',
  agree: 'Келишиш',
  disagree: 'Рад этиш',
  agreementCommentLabel: 'Изоҳ (мажбурий)',
  agreementCommentPlaceholder: 'Фикрингизни ёзинг...',
  agreementCommentRequired: 'Изоҳ киритилиши шарт',
  submitAgreement: 'Келишувга юбориш',
  sendToRegistry: 'Девонхонага юбориш',
  agreementState: {
    agreed: 'Келишилди',
    declined: 'Рад этилди',
    pending: 'Кутилмоқда',
  ...
  editReturnDate: 'Ўзгартириш',
  editReturnDateTitle: 'Келган санани ўзгартириш',
  editReturnDateHint: 'Сана гувоҳномага ва табелга ҳам кўчади.',
  selfFinish: 'Сафарни якунлаш',
  selfFinishTitle: 'Сафарни якунлаш',
  selfFinishConfirm: 'Ростдан ҳам хизмат сафарини якунламоқчимисиз? Қайтиш санаси сифатида турникетдан (Face ID) ўтган санангиз — {{date}} ёзилади. Кейин ҳисобот ёзиш очилади ва кадрга хабар боради.',
  ...
  mainSignerRequired: 'Раҳбарият (адресат) танланиши шарт',
  coordinatorsRequired: 'Аризада камида битта келишувчи бўлиши шарт',
