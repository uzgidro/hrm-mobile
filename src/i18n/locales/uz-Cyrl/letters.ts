...
export default {
  ...
  vehicleNone: 'Сафар машинасиз расмийлаштирилган',
  vehicleAsk: 'Машина сўраш',
  vehicleAskSubmit: 'Сўраш',
  vehicleAskAgain: 'Қайта сўраш',
  vehicleNotNeeded: 'Машина керак эмас',
  vehicleNotePlaceholder: 'Изоҳ (ихтиёрий): неча киши, чиқиш вақти...',
  vehicleAssignedByBfd: 'Машинани БФД бириктиради — айнан қайси машина бўлишини сиз танламайсиз.',
  vehicleRequested: 'Машина сўралган',
  vehicleStatusPending: 'БФД жавоби кутилмоқда',
  vehicleStatusApproved: 'Машина бириктирилди',
  vehicleStatusRejected: 'Рад этилган',
  vehicleNote: 'Ходим изоҳи',
  vehicleDriver: 'Ҳайдовчи',
  vehicleResponse: 'БФД жавоби',
  vehicleDriverTripOpened: 'Ҳайдовчига хизмат сафари очилди ва рўйхатга олинди',
  vehicleCostEstimated: 'Тахминий',
  vehicleCostActual: 'Аниқ',
  vehicleAssign: 'Машина бириктириш',
  vehicleReassign: 'Машинани алмаштириш',
  vehicleReject: 'Рад этиш',
  vehiclePickHint: 'Машинани танланг:',
  vehiclePickRequired: 'Машинани танланг',
  vehicleRejectReason: 'Нима учун берилмади? (мажburий)',
  vehicleRejectReasonRequired: 'Рад этиш сабабини ёзинг',
  vehicleResponseNote: 'Изоҳ (ихтиёрий): чиқиш вақти, қўшимча шартлар...',
  vehicleApproveHint: 'Тасдиқласангиз ҳайдовчига хизмат сафари автоматик очилади ва рўйхатга олинади.',
  vehicleBusy: 'Банд — бу саналарда бошқа сафарда',
  vehicleNoDriverWarning: 'Бу машинага ҳайдовчи бириктирилмаган — аввал автопаркда ҳайдовчи белгиланг.',
  sum: 'сўм',
  vehicleNeeded: 'Машина керак',
  vehicleWithout: 'Машинасиз',
} as const;
