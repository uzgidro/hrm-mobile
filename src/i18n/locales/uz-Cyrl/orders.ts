...
export default {
  ...
  sectionComments: 'Изоҳлар',
  commentsEmpty: 'Ҳозирча изоҳ йўқ',
  commentPlaceholder: 'Изоҳ ёзинг...',
  commentSend: 'Юбориш',
  sectionEditHistory: 'Матн таҳрири тарихи',
  editHistoryTextChanged: 'Буйруқ матни ўзгартирилди',
  kvEmployee: 'Ходим',
  ...
  actionSubmitToSubmitter: 'Киритувчига юбориш',
  actionSubmitToApprovers: 'Келишувчиларга юбориш',
  submitSuccess: 'Буйруқ юборилди',
