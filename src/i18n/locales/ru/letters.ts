...
export default {
  ...
  vehicleNone: 'Командировка оформлена без автомобиля',
  vehicleAsk: 'Запросить автомобиль',
  vehicleAskSubmit: 'Запросить',
  vehicleAskAgain: 'Запросить снова',
  vehicleNotNeeded: 'Автомобиль не нужен',
  vehicleNotePlaceholder: 'Комментарий (необязательно): сколько человек, время выезда...',
  vehicleAssignedByBfd: 'Автомобиль назначает БФД — конкретную машину вы не выбираете.',
  vehicleRequested: 'Автомобиль запрошен',
  vehicleStatusPending: 'Ожидается ответ БФД',
  vehicleStatusApproved: 'Автомобиль назначен',
  vehicleStatusRejected: 'Отклонено',
  vehicleNote: 'Комментарий сотрудника',
  vehicleDriver: 'Водитель',
  vehicleResponse: 'Ответ БФД',
  vehicleDriverTripOpened: 'Водителю открыта командировка и зарегистрирована',
  vehicleCostEstimated: 'Ориентировочно',
  vehicleCostActual: 'Фактически',
  vehicleAssign: 'Назначить автомобиль',
  vehicleReassign: 'Заменить автомобиль',
  vehicleReject: 'Отклонить',
  vehiclePickHint: 'Выберите автомобиль:',
  vehiclePickRequired: 'Выберите автомобиль',
  vehicleRejectReason: 'Причина отказа (обязательно)',
  vehicleRejectReasonRequired: 'Укажите причину отказа',
  vehicleResponseNote: 'Комментарий (необязательно): время выезда, условия...',
  vehicleApproveHint: 'После подтверждения водителю автоматически откроется и зарегистрируется командировка.',
  vehicleBusy: 'Занят — в эти даты в другой поездке',
  vehicleNoDriverWarning: 'К этому автомобилю не привязан водитель — сначала назначьте его в автопарке.',
  sum: 'сум',
  vehicleNeeded: 'Нужен автомобиль',
  vehicleWithout: 'Без автомобиля',
} as const;
