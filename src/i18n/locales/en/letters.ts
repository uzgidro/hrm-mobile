...
export default {
  ...
  vehicleNone: 'Trip is arranged without a vehicle',
  vehicleAsk: 'Request a vehicle',
  vehicleAskSubmit: 'Request',
  vehicleAskAgain: 'Request again',
  vehicleNotNeeded: 'No vehicle needed',
  vehicleNotePlaceholder: 'Note (optional): how many people, departure time...',
  vehicleAssignedByBfd: 'BFD assigns the vehicle — you do not pick a specific car.',
  vehicleRequested: 'Vehicle requested',
  vehicleStatusPending: 'Waiting for BFD',
  vehicleStatusApproved: 'Vehicle assigned',
  vehicleStatusRejected: 'Rejected',
  vehicleNote: 'Employee note',
  vehicleDriver: 'Driver',
  vehicleResponse: 'BFD response',
  vehicleDriverTripOpened: 'A business trip was opened and registered for the driver',
  vehicleCostEstimated: 'Estimated',
  vehicleCostActual: 'Actual',
  vehicleAssign: 'Assign vehicle',
  vehicleReassign: 'Change vehicle',
  vehicleReject: 'Reject',
  vehiclePickHint: 'Pick a vehicle:',
  vehiclePickRequired: 'Pick a vehicle',
  vehicleRejectReason: 'Why was it rejected? (required)',
  vehicleRejectReasonRequired: 'Write the rejection reason',
  vehicleResponseNote: 'Note (optional): departure time, extra conditions...',
  vehicleApproveHint: 'On approval the driver automatically gets a registered business trip.',
  vehicleBusy: 'Busy — on another trip on these dates',
  vehicleNoDriverWarning: 'This vehicle has no driver attached — set one in the fleet first.',
  sum: 'UZS',
  vehicleNeeded: 'Vehicle needed',
  vehicleWithout: 'Without a vehicle',
} as const;
