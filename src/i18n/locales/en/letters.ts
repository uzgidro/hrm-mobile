...
export default {
  ...
  basisDecreeSet: 'Enter',
  basisDecreeNumber: 'Decree number',
  basisDecreeNumberPlaceholder: 'For example: 145',
  basisDecreeDate: 'Decree date',
  ...
  extendTripAction: 'Extend the trip',
  extensionApprove: 'Approve the extension',
  extensionReject: 'Reject',
  extensionDecideConfirm: 'A decision will be recorded for the trip-extension request.',
  fieldDate: 'Date',
  ...
  fieldCreator: 'Document author',
  creatorSelf: 'Myself (current user)',
  pickerCreator: 'Document author',
