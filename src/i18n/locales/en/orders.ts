...
export default {
  ...
  commentSend: 'Send',
  sectionEditHistory: 'Text edit history',
  editHistoryTextChanged: 'The decree text was changed',
  kvEmployee: 'Employee',
  kvSubmitter: 'Sender',
  ...
  actionSubmitToSubmitter: 'Send to submitter',
  actionSubmitToApprovers: 'Send to approvers',
  submitSuccess: 'Decree submitted',
