...
export default {
  ...
  sectionComments: 'Izohlar',
  commentsEmpty: 'Hozircha izoh yo\'q',
  commentPlaceholder: 'Izoh yozing...',
  commentSend: 'Yuborish',
  sectionEditHistory: 'Matn tahriri tarixi',
  editHistoryTextChanged: 'Buyruq matni o\'zgartirildi',
  kvEmployee: 'Xodim',
  ...
  sectionFamiliarizerDepts: "Tanishuvchi bo'limlar",
  actionApply: "Qo'llash",
  applyTitle: "Buyruqni qo'llash",
  applyHint: "Ta'til / ko'chirish yozuvi yaratiladi va buyruq yakunlanadi.",
  applyEmployee: 'Xodim',
  ...
  actionSubmitToSubmitter: 'Kirituvchiga yuborish',
  actionSubmitToApprovers: 'Kelishuvchilarga yuborish',
  submitSuccess: 'Buyruq yuborildi',
