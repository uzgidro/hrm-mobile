...
export default {
  ...
  vehicleApprovalNeeded: 'Mashina so\'rovi — tasdiqlang',
  vehicleApprovalAnswered: 'Mashina so\'rovi bo\'yicha qaror',
  fuelPricePending: 'Yoqilg\'i narxi tasdiqlanishi kerak',
  ...
  businessTripReportReturned: 'Safar hisoboti qaytarildi',
  cardAttachmentAdded: 'Vazifaga fayl biriktirildi',
  cardDeleted: "Vazifa o'chirildi",
  cardMemberRemoved: 'Vazifadan chiqarildingiz',
  cardUncompleted: 'Vazifa qayta ochildi',
  cardUpdated: "Vazifa o'zgartirildi",
  kpiPerformanceCreated: "KPI ko'rsatkichi kiritildi",
  kpiPerformanceStatus: "KPI holati o'zgardi",
  orderActApplied: "Buyruq qo'llandi",
  orderActCommented: 'Buyruqqa izoh yozildi',
