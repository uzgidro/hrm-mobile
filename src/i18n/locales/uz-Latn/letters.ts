...
export default {
  ...
  openGuvohnoma: 'Guvohnomani ochish',
  openAttachment: 'Ilovani ochish',
  openReportDocument: 'Hisobotni ochish',
  reportDocumentTitle: 'Hisobot',
  guvohnomaDocumentTitle: 'Guvohnoma',
  attachmentDocumentTitle: 'Ilova',
  docOutOfSyncWarning:
  ...
  fieldAuthor: 'Muallif',
  detailLeadership: 'Rahbariyat',
  fieldAddressee: 'Adresat',
  fieldActualReturn: 'Kelgan sana (KADR)',
  fieldBasisDecree: 'Asos buyruq (KADR)',
  basisDecreeSet: 'Kiritish',
  basisDecreeNumber: 'Buyruq raqami',
  basisDecreeNumberPlaceholder: 'Masalan: 145',
  basisDecreeDate: 'Buyruq sanasi',
  fieldGuvohnomaNumber: 'Guvohnoma raqami',
  fieldRegistry: 'Devonxona ro\'yxati',
  registryNotRegistered: 'Ro\'yxatdan o\'tmagan',
  sectionWorkPlan: 'Reja / maqsad',
  extensionPending: 'Safarni {{date}} gacha uzaytirish so\'ralgan — rahbariyat tasdig\'i kutilmoqda.',
  extendTripAction: 'Safarni uzaytirish',
  extensionApprove: 'Uzaytirishni tasdiqlash',
  extensionReject: 'Rad etish',
  extensionDecideConfirm: 'Safar muddatini uzaytirish so\'rovi bo\'yicha qaror qabul qilinadi.',
  fieldDate: 'Sana',
  fieldDeparture: 'Ketish',
  fieldReturn: 'Qaytish',
  sectionSigners: 'Imzolovchilar',
  sectionAgreement: 'Kelishuv',
  agree: 'Kelishish',
  disagree: 'Rad etish',
  agreementCommentLabel: 'Izoh (majburiy)',
  agreementCommentPlaceholder: 'Fikringizni yozing...',
  agreementCommentRequired: 'Izoh kiritilishi shart',
  submitAgreement: 'Kelishuvga yuborish',
  sendToRegistry: 'Devonxonaga yuborish',
  agreementState: {
    agreed: 'Kelishildi',
    declined: 'Rad etildi',
    pending: 'Kutilmoqda',
  ...
  editReturnDate: 'O\'zgartirish',
  editReturnDateTitle: 'Kelgan sanani o\'zgartirish',
  editReturnDateHint: 'Sana guvohnomaga va tabelga ham ko\'chadi.',
  ...
  cancelTripAction: 'Safarni bekor qilish',
  ...
  mainSignerRequired: 'Rahbariyat (adresat) tanlanishi shart',
  coordinatorsRequired: 'Arizada kamida bitta kelishuvchi bo\'lishi shart',
  regionRequired: 'Kamida bitta viloyat tanlanishi shart',
