...
export default {
  ...
  // ── Avtopark (mashina) ──
  vehicleSection: 'Transport',
  vehicleNone: 'Safar mashinasiz rasmiylashtirilgan',
  vehicleAsk: "Mashina so'rash",
  vehicleAskSubmit: "So'rash",
  vehicleAskAgain: "Qayta so'rash",
  vehicleNotNeeded: 'Mashina kerak emas',
  vehicleNotePlaceholder: 'Izoh (ixtiyoriy): necha kishi, chiqish vaqti...',
  vehicleAssignedByBfd: "Mashinani BFD biriktiradi — aynan qaysi mashina bo'lishini siz tanlamaysiz.",
  vehicleRequested: "Mashina so'ralgan",
  vehicleStatusPending: 'BFD javobi kutilmoqda',
  vehicleStatusApproved: 'Mashina biriktirildi',
  vehicleStatusRejected: 'Rad etilgan',
  vehicleNote: 'Xodim izohi',
  vehicleDriver: 'Haydovchi',
  vehicleResponse: 'BFD javobi',
  vehicleDriverTripOpened: "Haydovchiga xizmat safari ochildi va ro'yxatga olindi",
  vehicleCostEstimated: 'Taxminiy',
  vehicleCostActual: 'Aniq',
  vehicleAssign: 'Mashina biriktirish',
  vehicleReassign: 'Mashinani almashtirish',
  vehicleReject: 'Rad etish',
  vehiclePickHint: 'Mashinani tanlang:',
  vehiclePickRequired: 'Mashinani tanlang',
  vehicleRejectReason: 'Nima uchun berilmadi? (majburiy)',
  vehicleRejectReasonRequired: 'Rad etish sababini yozing',
  vehicleResponseNote: "Izoh (ixtiyoriy): chiqish vaqti, qo'shimcha shartlar...",
  vehicleApproveHint: "Tasdiqlansangiz haydovchiga xizmat safari avtomatik ochiladi va ro'yxatga olinadi.",
  vehicleBusy: 'Band — bu sanalarda boshqa safarda',
  vehicleNoDriverWarning: 'Bu mashinaga haydovchi biriktirilmagan — avval avtoparkda haydovchi belgilang.',
  sum: "so'm",
  vehicleNeeded: 'Mashina kerak',
  vehicleWithout: 'Mashinasiz',
} as const;
